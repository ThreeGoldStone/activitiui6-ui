...
public class StencilSetResource {
	...
	public JsonNode getStencilSetForEditor(@RequestParam(required = false, value = "lang") String lang) {
		try {
			log.info(lang);
			String fileName = "stencilset_bpmn.json";
			if("en".equals(lang)) {
				fileName = "stencilset_bpmn-en.json";
			}
